...
contract MoboNft is ERC1155, Ownable {
    ...
    uint256 public constant Motherboard = 0;

    mapping (uint256 => Motherboard) private _tokendetails;

        constructor(string memory name, string memory symbol) public ERC1155(name, symbol) {
        _mint(msg.sender, Motherboard, 1, "");
    }
